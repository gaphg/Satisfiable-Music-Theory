    ...
    DefinitionStmt
      (FuncDefStmt
         ( "isDissonant",
           [ ("p1", None); ("p2", None) ],
           Contains
             ( ListExpr [ Var "m2"; Var "M2"; Var "Tritone"; Var "m7"; Var "M7" ],
               IntervalBetween (Var "p1", Var "p2") ) ));
    DefinitionStmt
      (FuncDefStmt
         ( "hasSuspension",
           [ ("v1", None); ("v2", None); ("t", None) ],
           And
             ( And
                 ( Equals
                     ( ElementAt (Pitches (Var "v1"), Var "t"),
                       ElementAt
                         (Pitches (Var "v1"), Plus (Var "t", TimeStepLit 1)) ),
                   FuncCall
                     ( "isConsonant",
                       [
                         ElementAt (Pitches (Var "v1"), Var "t");
                         ElementAt (Pitches (Var "v2"), Var "t");
                       ] ) ),
               FuncCall
                 ( "isDissonant",
                   [
                     ElementAt
                       (Pitches (Var "v1"), Plus (Var "t", TimeStepLit 1));
                     ElementAt
                       (Pitches (Var "v2"), Plus (Var "t", TimeStepLit 1));
                   ] ) ) ));
              ...
              And
                ( FuncCall
                    ( "isConsonant",
                      [
                        ElementAt
                          (Pitches (Var "v1"), Plus (Var "t", TimeStepLit 2));
                        ElementAt
                          (Pitches (Var "v2"), Plus (Var "t", TimeStepLit 2));
                      ] ),
                  Or
                    ( Equals
                        ( ElementAt
                            (Contour (Var "v1"), Plus (Var "t", TimeStepLit 1)),
                          Var "m2" ),
                      Equals
                        ( ElementAt
                            (Contour (Var "v1"), Plus (Var "t", TimeStepLit 1)),
